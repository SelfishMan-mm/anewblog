  ...
  return (
    <ComponentErrorBoundary componentName="ContactSection">
      <section 
        id="contact" 
        ref={sectionRef}
        className="min-h-screen py-20 px-8 bg-gradient-to-br from-slate-900 via-blue-900/20 to-slate-900 relative overflow-hidden"
      >
        {/* 背景装饰 */}
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">点击复制到剪贴板</p>
                  </div>
                </div>
                ...
                <CoolMode options={{ particleCount: 6, speedHorz: 8, speedUp: 15 }}>
                  <button
                    ...
                    className="w-full p-3 bg-slate-700/50 hover:bg-slate-700 rounded-lg text-slate-300 hover:text-white transition-all duration-200 font-mono text-sm border border-slate-600/50 hover:border-blue-500/50"
                  >
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-400">关注我的最新动态</p>
                </div>
              </div>
                ...
                {socialLinks.map((social) => (
                  <CoolMode key={social.platform} options={{ particleCount: 4, speedHorz: 6, speedUp: 12 }}>
                    <button
                      ...
                      className="w-full flex items-center gap-3 p-3 bg-slate-700/50 hover:bg-slate-700 rounded-lg text-slate-300 hover:text-white transition-all duration-200 border border-slate-600/50 hover:border-purple-500/50 group"
                    >
        ...
        <div className="relative my-12 flex items-center justify-center">
          ...
          <div className="relative bg-slate-900 px-6 text-slate-400">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-4 bg-slate-700/50 border border-slate-600/50 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-colors"
                  placeholder="请输入你的姓名"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-4 bg-slate-700/50 border border-slate-600/50 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-colors resize-none"
                  placeholder="写下你想说的话..."
                  required
                />
              </div>
